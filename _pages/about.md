...
profile:
  align: right
  image: my_pic_grey.jpg  # 确保这张图片已经放入了 assets/img/ 文件夹中
  image_circular: false # crops the image to make it circular
  more_info: >
    <p>School of Instrument Science and Engineering</p>
...
latest_posts:
  enabled: false  # 如果你不写博客，建议设为 false，保持页面整洁
  scrollable: true 
  limit: 3 
---

Dr. **Xuhui Hu** is currently an **Assistant Professor** at the School of Instrument Science and Engineering, Southeast University, China. He received his Ph.D. degree in 2022 from Southeast University under the supervision of Prof. [Aiguo Song](https://scholar.google.com/citations?user=RjQ5TrEAAAAJ&hl=zh-CN&oi=ao).
...
[Google Scholar](https://scholar.google.com/citations?user=o-gCG4kAAAAJ&hl=en&inst=6453797383205921872) | [ResearchGate](https://www.researchgate.net/profile/Xuhui-Hu-2)